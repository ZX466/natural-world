...
**M4-D2b 已交待收编**（structure 单折叠/投影/重放 + checkpoint 纯函数，见 ③节 2026-09-26 D2b 快照与 talking.txt 回执）。下一批 D2c：10k 内存承重图、无环/同分支/稳定排序级联，按帧摊还与每帧事件预算；再 D2d 材料守恒/TILE_CHANGED。
