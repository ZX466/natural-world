...
**M4-D2 三批已交待收编**（D2a `c719171` / D2b `345d5ae` / D2c 待写入；见 ③节 2026-09-26 三条快照与 talking.txt 回执）。下一单 D2d：MATERIAL_MOVED 资源投影/同事务回滚守恒 T1 + TILE_CHANGED 派生与 C3 chunk 失效接线。
