...
**M4-D1 建造域数据面预研已交提案待裁**（`docs/data/build-domain-preplan.md`；事件族、checkpoint、承重图、材料守恒与 7 个待裁点，见 ③节 2026-09-25 快照与 talking.txt 回执）。本单只出文档，不改代码；等 Claude 裁决后再进 M4-D2。
